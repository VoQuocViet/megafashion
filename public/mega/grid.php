...
<div class="page"> 
  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <ul>
          <li class="home"> <a href="index.php" title="Go to Home Page">Home</a><span>&raquo; </span></li>
          <li class=""> <a href="grid.php" title="Go to Home Page">Women</a><span>&raquo; </span></li>
      ...
      <div class="row">
        <section class="col-main col-sm-9 col-sm-push-3">
          ...
          <div class="category-products">
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <span class="button button-active button-grid" title="Grid">Grid</span><a class="button button-list" title="List" href="list.php">List</a> </div>
              </div>
              <div id="sort-by">
                ...
                <a title="Set Descending Direction" href="#" class="button-asc left"><span class="glyphicon glyphicon-arrow-up" style="color:#999;font-size:11px;"></span></a> </div>
              <div class="pager">
                <div class="pages">
                  <label>Page:</label>
                  <ul class="pagination">
            ...
            <ul class="products-grid">
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product1.jpg" alt="Ut tincidunt tortor"></a>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product2.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product3.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php" class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product4.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product5.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product8.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product10.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product11.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product9.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
              ...
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="col-item">
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a href="product_detail.php" title="Sample Product" class="product-image"> <img src="products-images/product13.jpg" alt="Ut tincidunt tortor"></a>
                        <div class="item-box-hover">
                          <div class="box-inner">
                            <div class="product-detail-bnt"><a href="quick_view.php"  class="button detail-bnt"><span>Quick View</span></a></div>
                          </div>
        ...
        <aside class="col-right sidebar col-sm-3 col-xs-12 col-sm-pull-9">
          <div class="side-nav-categories">
            ...
            <div class="box-content box-category">
              <ul>
                <li> <a class="active" href="#/women.php">Women</a> <span class="subDropdown minus"></span>
                  <ul class="level0_415" style="display:block">
                    <li> <a href="grid.php"> Tops </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Evening Tops </a> </li>
                        <li> <a href="grid.php"> Shirts &amp; Blouses </a> </li>
                        <li> <a href="grid.php"> Tunics </a> </li>
                        <li> <a href="grid.php"> Vests </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Bags </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Bags </a> </li>
                        <li> <a href="grid.php"> Designer Handbags </a> </li>
                        <li> <a href="grid.php"> Purses </a> </li>
                        <li> <a href="grid.php"> Shoulder Bags </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Shoes </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                    ...
                    <!--level1-->
                    <li> <a href="grid.php"> Jewellery </a>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Bracelets </a> </li>
                        <li> <a href="grid.php"> Necklaces &amp; Pendants </a> </li>
                    ...
                    <!--level1-->
                    <li> <a href="grid.php"> Dresses </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                    ...
                    <!--level1-->
                    <li> <a href="grid.php"> Lingerie </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Bras </a> </li>
                        <li> <a href="grid.php"> Bodies </a> </li>
                        <li> <a href="grid.php"> Lingerie Sets </a> </li>
                        <li> <a href="grid.php"> Shapewear </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Jackets </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Coats </a> </li>
                        <li> <a href="grid.php"> Jackets </a> </li>
                        <li> <a href="grid.php"> Leather Jackets </a> </li>
                        <li> <a href="grid.php"> Blazers </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Swimwear </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                ...
                <!--level 0-->
                <li> <a href="grid.php">Men</a> <span class="subDropdown plus"></span>
                  <ul class="level0_455" style="display:none">
                    <li> <a href="#/men/shoes.php"> Shoes </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Flat Shoes </a> </li>
                        <li> <a href="grid.php"> Boots </a> </li>
                        <li> <a href="grid.php"> Heels </a> </li>
                    ...
                    <!--level1-->
                    <li> <a href="grid.php"> Jewellery </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Bracelets </a> </li>
                        <li> <a href="grid.php"> Necklaces &amp; Pendants </a> </li>
                        <li> <a href="grid.php"> Pins &amp; Brooches </a> </li>
                ...
                <!--level 0-->
                <li> <a href="grid.php">Electronics</a> <span class="subDropdown plus"></span>
                  <ul class="level0_482" style="display:none">
                    <li> <a href="grid.php"> Smartphones </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Samsung </a> </li>
                        <li> <a href="grid.php"> Apple </a> </li>
                        <li> <a href="grid.php"> Blackberry </a> </li>
                        <li> <a href="grid.php"> Nokia </a> </li>
                        <li> <a href="grid.php"> HTC </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Cameras </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> Digital Cameras </a> </li>
                        <li> <a href="grid.php"> Camcorders </a> </li>
                        <li> <a href="grid.php"> Lenses </a> </li>
                        <li> <a href="grid.php"> Filters </a> </li>
                        <li> <a href="grid.php"> Tripod </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                    <!--level1-->
                    <li> <a href="grid.php"> Accesories </a> <span class="subDropdown plus"></span>
                      <ul class="level1" style="display:none">
                        <li> <a href="grid.php"> HeadSets </a> </li>
                        <li> <a href="grid.php"> Batteries </a> </li>
                        <li> <a href="grid.php"> Screen Protectors </a> </li>
                        <li> <a href="grid.php"> Memory Cards </a> </li>
                        <li> <a href="grid.php"> Cases </a> </li>
                        <!--end for-each -->
                      </ul>
                      <!--level1--> 
                    </li>
                ...
                <!--level 0-->
                <li> <a href="grid.php">Digital</a> </li>
                <!--level 0-->
                <li class="last"> <a href="grid.php">Fashion</a> </li>
                <!--level 0-->
              </ul>
            </div>
          ...
          <div class="block block-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                <li class="item"> <a class="product-image" title="Fisher-Price Bubble Mower" href="product_detail.php"><img width="60" alt="Fisher-Price Bubble Mower" src="products-images/product1.jpg"></a>
                ...
                <li class="item last"> <a class="product-image" title="Prince Lionheart Jumbo Toy Hammock" href="product_detail.php"><img width="60" alt="Prince Lionheart Jumbo Toy Hammock" src="products-images/product2.jpg"></a>
                  <div class="product-details">
                    <div class="access"> <a class="btn-remove1" title="Remove This Item" href="#"> <span class="icon"></span> Remove </a> </div>
                    <p class="product-name"> <a href="product_detail.php"> Sample  Product </a> </p>
          ...
          <div class="block block-banner"><a href="#"><img src="images/block-banner.png" alt=""></a></div>
        </aside>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="js/revslider.php"></script> 
