    ...
    <div class="container">
      <div class="nav-inner"> 
        ...
        <ul id="nav" class="hidden-xs">
           <li class="level1" ><a href="index.html"><span>Home</span> </a>
          ...
          <li class="level0 nav-7 level-top parent"> <a class="level-top" href="grid.html"> <span>Furniture</span> </a>
            <div class="level0-wrapper dropdown-6col" style="left: 0pt; display: none;">
              <div class="level0-wrapper2">
                ...
                <div class="nav-block nav-block-right std grid12-4"><a href="#/electronics/phone-accessories.html"><img src="images/menu_furniture.png" class="fade-on-hover" alt="product"></a> </div>
              </div>
            </div>
          </li>
    ...
    <div class="container">
      <div class="std">
        <div class="page-not-found wow bounceInRight animated">
          <h2>404</h2>
          <h3><img src="images/signal.png" alt="signal_img">Oops! The Page you requested was not found!</h3>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
            <h4>Style Advisor</h4>
            <ul class="links">
              <li class="first"><a href="login.html" title="Your Account">Your Account</a></li>
