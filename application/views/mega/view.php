                  ...
                  <div class="product-image">
                    <div class="large-image"> 
                      <a href="" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20">
                         <img alt="product-image" src="<?php echo base_url()?>/upload/product/<?php echo $product->image_link?>"> 
                      </a> 
                    </div>
              ...
              <div class="product-shop col-lg-7 col-sm-5 col-xs-12">
                  ...
                  <div class="price-block">
                    <div class="price-box">
                      ...
                      <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> <?php echo $product->discount ?> </span> </p>
                    </div>
                  </div>
