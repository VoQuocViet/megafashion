...
<title>Shop Thời Trang| <?php echo $product->name?></title>
<!-- Favicons Icon -->
...
<link rel="stylesheet" href="<?php echo public_url()?>/mega/css/fancybox.css" type="text/css">
...
<div style="width: 1190px; height: auto; top: 20%; left: 24%; display: block;" id="fancybox-wrap">
        ...
        <div class="product-view">
          <div class="product-essential">
            <form action="#" method="post" id="product_addtocart_form">
              ...
              <div class="product-img-box col-lg-5 col-sm-4 col-xs-12">
                  <div class="new-label new-top-left"> New </div>
                  <div class="product-image">
                    <div class="large-image"> <a href="products-images/product4.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img alt="product-image" src="<?php echo base_url()?>/upload/product/<?php echo $product->image_link?>"> </a> </div>
              ...
              <div class="product-shop col-lg-7 col-sm-5 col-xs-12">
                  <div class="product-next-prev"> <a class="product-next" href="#"><span></span></a> <a class="product-prev" href="#"><span></span></a> </div>
                  <div class="product-name">
                    <h1><?php echo $product->name?></h1>
                  </div>
                  <div class="short-description">
                    <p> Nội Dung: <?php echo $product->content?> </p>
                    <p> Mô Tả: <?php echo $product->meta_desc?> </p>
...
<!-- JavaScript --> 
<script type="text/javascript" src="<?php echo public_url()?>/mega/<?php echo public_url()?>/mega/js/prototype.js"></script> 
