			...
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						...
						<p> Nếu cập nhật mật khẩu thì mưới nhập giá trị</p>
						</span>
						<span name="name_autocheck" class="autocheck"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="created" id="param_created" _autocheck="true" type="date" value="<?php echo $info->created ?>"></span>
						<span name="name_autocheck" class="autocheck"></span>
