...
<div class="wrapper">
	   	...
	   	<!-- Form -->
		<form enctype="multipart/form-data" method="post" action="<?php echo admin_url('news/edit')?>" id="form" class="form">
			<fieldset>
				<div class="widget">
				    <div class="title">
					...
					<div class="tab_container">
					     <div class="tab_content pd0" id="tab1" style="display: block;">
											...
											<?php if(count($row->subs) > 1):?>
							  				<optgroup label="<?php echo $row->name?>">
							  				    <?php foreach ($row->subs as $sub):?>
							           			<option value="<?php echo $sub->id?>"<?php if($sub->id == $news->catalognews_id) echo 'selected';?>> ---<?php echo $sub->name?> </option>
								                <?php endforeach;?>
							           		</optgroup>
							           		<?php else:?>
							           		  <option value="<?php echo $row->id?>"<?php if($row->id == $news->catalognews_id) echo 'selected';?> style="font-weight:bold;"><?php echo $row->name?></option>
							           		<?php endif;?>
							           		<?php endforeach;?>
									</select>
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><textarea cols="" rows="4" id="param_intro" name="intro"><?php echo $news->intro ?></textarea></span>
...
<div class="formRow">
	<label for="param_created" class="formLeft">Ngày Tạo :</label>
		<div class="formRight">
			<span class="oneFour"><input type="date" id="param_created" name="created" value="<?php echo $news->created ?>" style="height:35px; width:368px"></span>
...
<div class="formRow">
	...
	<div class="clear"></div>
	        		...
	        		<div class="formSubmit">
	           			<input type="submit" class="redB" value="Cap nhat">
